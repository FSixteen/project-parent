...
/**
 * 启动类 java技术交流群 : 326337220, 欢迎各位技术爱好者共同交流学习 由于之前的代码没写注释并且结构混乱,
 * 因此重构一版方便有需要的朋友参考, 具体关于dht协议细节可以参考网上的这篇翻译 :
...
public class Main {
  public static void main(String[] args) throws Exception {
    ...
    // 这里表示从60000到60255这256个端口将会被监听, 也就是一共会创建256个dht节点,
    // 修改节点数量时确保下面生成id的逻辑产生的id长度为20字节
